...
func NewBackupStrategyResolver(mysql appservices.BackupStrategy, postgres appservices.BackupStrategy, mongo appservices.BackupStrategy) appservices.BackupStrategyResolver {
	return &backupStrategyResolver{mysql: mysql, postgres: postgres, mongo: mongo}
}
...
func NewRestoreStrategyResolver(mysql appservices.RestoreStrategy, postgres appservices.RestoreStrategy, mongo appservices.RestoreStrategy) appservices.RestoreStrategyResolver {
	return &restoreStrategyResolver{mysql: mysql, postgres: postgres, mongo: mongo}
}
